...
public class Vision extends SubsystemBase {
  ...
  public static int seenTagId() {
    ...
    if (frontLeftCameraSeenTagID != 23) {
      ...
      return frontRightCameraSeenTagID;
    } else {
      return 23;
    }
  }
  ...
  public static Rotation2d rotationOppositeToTagRotation2d(int... tagId) {
    if (tagId.length > 0) {
      ...
      if (frontLeftCameraSeenTagID < 24) {
        ...
        return tagPoses[frontRightCameraSeenTagID - 1].getRotation().plus(new Rotation2d(Math.PI));
      } else {
      ...
      for (var observation : inputs[cameraIndex].poseObservations) {
        ...
        boolean rejectPose =
            observation.tagCount() == 0 // Must have at least one tag
                ...
                || (observation.pose().getX() == 0 && observation.pose().getY() == 0)
